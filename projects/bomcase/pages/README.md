...
* `pages/*.md` 不替代 `../sources/` 的原始事实材料；
* 如需核对事实，读取 `../sources/*-handoff.md`。

## 2. 当前页面清单

| 页面 | Brief | Source | status | knowledge_role | 待确认数量 | 说明 |
|---|---|---|---|---|---:|---|
| home | `home.md` | `../sources/home-handoff.md` | current | handoff-brief | 2 | 用于研发交接、页面理解和待确认承接。 |
| shop | `shop.md` | `../sources/shop-handoff.md` | current | handoff-brief | 0 | 用于研发交接、页面理解和待确认承接。 |
| open-box | `open-box.md` | `../sources/open-box-handoff.md` | current | fact-brief | 5 | 已治理沉淀，可作为当前页面口径承接层。 |
| open-box-result | `open-box-result.md` | `../sources/open-box-result-handoff.md` | current | handoff-brief | 1 | 用于研发交接、页面理解和待确认承接。 |
| toy-collection | `toy-collection.md` | `../sources/toy-collection-handoff.md` | current | handoff-brief | 8 | 用于研发交接、页面理解和待确认承接。 |
...
5. 如需要核对事实，读 `../sources/*-handoff.md`。

## 4. 页面 brief 使用边界

* `pages/*.md` 是当前可读页面层，但不同文件的知识性质可能不同；
* `pages/*.md` 不替代 `../sources/` 原始事实材料；
* `pages/*.md` 不定义完整业务规则；
...
* `pages/*.md` 由 `../sources/`、`../decisions.md`、`../pending.md` 以及人工确认结果整理形成；
* `handoff-brief` 主要用于研发交接、页面理解和待确认承接，不等同于事实源；
* `fact-brief` 可作为当前页面口径承接层使用；
* 若 `pages/*.md` 与 `../sources/` 原始材料存在差异，应优先检查是否存在后续 decision / pending / 人工确认记录；
* 事实争议或核对场景统一回到 `../sources/*-handoff.md`。
