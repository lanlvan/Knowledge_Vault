...
| toy-collection | `pages/toy-collection.md` | `sources/toy-collection.md` | current | fact-brief | 当前已具备页面事实入口能力，详细事实仍由 active source 承载。 |
...
* 当前 `open-box.md`、`open-box-result.md`、`shop.md` 与 `toy-collection.md` 为 `fact-brief`；`home.md` 仍为 `handoff-brief`；
...
* `open-box.md`、`open-box-result.md`、`shop.md`、`toy-collection.md` 当前为 `fact-brief`；`home.md` 当前为 `handoff-brief`；
